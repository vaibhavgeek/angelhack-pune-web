...
class NgosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ngo" do
    assert_difference('Ngo.count') do
      post ngos_url, params: { ngo: { Description: @ngo.Description, Name: @ngo.Name, contact: @ngo.contact, labels: @ngo.labels } }
    end
  ...
  test "should update ngo" do
    patch ngo_url(@ngo), params: { ngo: { Description: @ngo.Description, Name: @ngo.Name, contact: @ngo.contact, labels: @ngo.labels } }
