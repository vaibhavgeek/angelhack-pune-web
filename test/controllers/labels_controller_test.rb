...
class LabelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create label" do
    assert_difference('Label.count') do
      post labels_url, params: { label: { laws_code: @label.laws_code, laws_description: @label.laws_description, name: @label.name } }
    end
  ...
  test "should update label" do
    patch label_url(@label), params: { label: { laws_code: @label.laws_code, laws_description: @label.laws_description, name: @label.name } }
